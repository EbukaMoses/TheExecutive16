...
import { FaEnvelope, FaLinkedin, FaSkype, FaSquareFacebook, FaSquareInstagram, FaSquarePhone, FaSquareXTwitter } from "react-icons/fa6";
        ...
        <div className="flex flex-col lg:flex-row gap-10 mt-5 mb-24">
            <div className="w-full lg:w-[30%]">
                <div className="w-[350px] mb-3 overflow-hidden">
                    <img src={User} alt="" className="w-full object-cover" />
                </div>
            </div>
